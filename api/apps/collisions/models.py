...
class MotorVehicleCollisionsCrashes(models.Model):
    id_collision = models.CharField(db_column='ID_COLLISION', primary_key=True, max_length=45)  # Field name made lowercase.
    crash_date = models.CharField(db_column='CRASH_DATE', max_length=45, blank=True, null=True)  # Field name made lowercase.
    crash_time = models.CharField(db_column='CRASH_TIME', max_length=45, blank=True, null=True)  # Field name made lowercase.
    week_day = models.CharField(db_column='WEEK_DAY', max_length=45, blank=True, null=True)  # Field name made lowercase.
    ...
    on_street_name = models.CharField(db_column='ON_STREET_NAME', max_length=45, blank=True, null=True)  # Field name made lowercase.
    cross_street_name = models.CharField(db_column='CROSS_STREET_NAME', max_length=45, blank=True, null=True)  # Field name made lowercase.
    off_street_name = models.CharField(db_column='OFF_STREET_NAME', max_length=45, blank=True, null=True)  # Field name made lowercase.
    number_of_persons_injured = models.CharField(db_column='NUMBER_OF_PERSONS_INJURED', max_length=45, blank=True, null=True)  # Field name made lowercase.
    number_of_persons_killed = models.CharField(db_column='NUMBER_OF_PERSONS_KILLED', max_length=45, blank=True, null=True)  # Field name made lowercase.
    number_of_pedestrians_injured = models.CharField(db_column='NUMBER_OF_PEDESTRIANS_INJURED', max_length=45, blank=True, null=True)  # Field name made lowercase.
    number_of_pedestrians_killed = models.CharField(db_column='NUMBER_OF_PEDESTRIANS_KILLED', max_length=45, blank=True, null=True)  # Field name made lowercase.
    number_of_cyclist_injured = models.CharField(db_column='NUMBER_OF_CYCLIST_INJURED', max_length=45, blank=True, null=True)  # Field name made lowercase.
    number_of_cyclist_killed = models.CharField(db_column='NUMBER_OF_CYCLIST_KILLED', max_length=45, blank=True, null=True)  # Field name made lowercase.
    number_of_motorist_injured = models.CharField(db_column='NUMBER_OF_MOTORIST_INJURED', max_length=45, blank=True, null=True)  # Field name made lowercase.
    number_of_motorist_killed = models.CharField(db_column='NUMBER_OF_MOTORIST_KILLED', max_length=45, blank=True, null=True)  # Field name made lowercase.
    contributing_factor_vehicle_1 = models.CharField(db_column='CONTRIBUTING_FACTOR_VEHICLE_1', max_length=45, blank=True, null=True)  # Field name made lowercase.
    contributing_factor_vehicle_2 = models.CharField(db_column='CONTRIBUTING_FACTOR_VEHICLE_2', max_length=45, blank=True, null=True)  # Field name made lowercase.
    contributing_factor_vehicle_3 = models.CharField(db_column='CONTRIBUTING_FACTOR_VEHICLE_3', max_length=45, blank=True, null=True)  # Field name made lowercase.
    contributing_factor_vehicle_4 = models.CharField(db_column='CONTRIBUTING_FACTOR_VEHICLE_4', max_length=45, blank=True, null=True)  # Field name made lowercase.
    contributing_factor_vehicle_5 = models.CharField(db_column='CONTRIBUTING_FACTOR_VEHICLE_5', max_length=45, blank=True, null=True)  # Field name made lowercase.
