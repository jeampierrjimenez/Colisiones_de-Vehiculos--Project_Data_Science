...
col1.metric("monday", round(df_day_crash.perc[0], 2), round(df_day_crash.perc[0] - prom, 2))
col2.metric("tuesday", round(df_day_crash.perc[1], 2), round(df_day_crash.perc[1] - prom, 2))
col3.metric("wednesday", round(df_day_crash.perc[2], 2), round(df_day_crash.perc[2] - prom, 2))
col4.metric("thursday", round(df_day_crash.perc[3], 2), round(df_day_crash.perc[3] - prom, 2))
col5.metric("friday", round(df_day_crash.perc[4], 2), round(df_day_crash.perc[4] - prom, 2))
col6.metric("saturday", round(df_day_crash.perc[5], 2), round(df_day_crash.perc[5] - prom, 2))
col7.metric("sunday", round(df_day_crash.perc[6], 2), round(df_day_crash.perc[6] - prom, 2))
